...
impl Recorder {
    ...
    fn update(&mut self, delta: Duration) {
        ...
        self.guidelines.update(
            ...
            1.0,
            time,
            piano_watterfall_core::dpi::LogicalSize::new(self.width as f32, self.height as f32),
        );
        ...
        if let Some(note_labels) = self.note_labels.as_mut() {
            note_labels.update(
                piano_watterfall_core::dpi::PhysicalSize {
                    width: self.width,
                    height: self.height,
                },
                1.0,
        ...
        self.text.update(
            piano_watterfall_core::dpi::PhysicalSize::new(self.width, self.height),
            1.0,
        );
    }
...
fn main() {
    env_logger::Builder::from_env(env_logger::Env::default().default_filter_or("piano_watterfall=info"))
        .init();
...
// TODO: This is copy-pasted from piano_watterfall/output_manager/synth_backend
